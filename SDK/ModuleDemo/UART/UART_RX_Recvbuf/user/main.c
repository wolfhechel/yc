/**
  ******************************************************************************
  * @file    3121Demo\ModuleDemo\UART\UART_RX_Rrcvbuf\user\main.c
  * @author  Yichip Application Team
  * @version V1.0.1
  * @date    21-July-2020
  * @brief   UART RX Recvbuf test program.
  ******************************************************************************
  * @attention
  *
...
void UART0_IRQHandler(void)
{
    ...
    {
        r = UART_RecvBuf(UART0, buf, 9);
        buf[r] = '\0';
    }
    MyPrintf("RecvBuf is %s\n", buf);
}
