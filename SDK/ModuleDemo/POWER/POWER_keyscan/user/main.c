/**
  ******************************************************************************
  * @file    3121Demo\ModuleDemo\POWER\POWER_keyscan\user\main.c
  * @author  Yichip Application Team
  * @version V1.0.1
  * @date    21-July-2020
  * @brief   POWER keyscan program.
  ******************************************************************************
  * @attention
  *
...
int main(void)
{
    ...
    MyPrintf("Yichip Yc3121 POWER Keyscan Demo V1.0.\r\n");
